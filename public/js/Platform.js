...
function Ball(xPos, yPos, w, h) {
    ...
    this.display = function () {
        ...
        for (var i = 0; i < this.platforms.length; i++) {
            ...
            // vertex(this.platforms[i].x + this.platforms[i].l + 20, this.platforms[i].y - 20 + this.platforms[i].w);
            // vertex(this.platforms[i].x + this.platforms[i].l, this.platforms[i].y) + this.platforms[i].w;
            endShape(CLOSE);
    ...
    this.mantain = function () {
        for (var i = this.platforms.length - 1; i >= 0; i--) {
            ...
            if (this.platforms[i].x < -.5 * width) {
                console.log("CHECK MANTAIN METHOD");
